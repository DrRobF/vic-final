  ...
  return (
    <header className="vicHeader">
      ...
      <style jsx>{`
        ...
        .brand img { width: 56px; height: 56px; border-radius: 14px; box-shadow: 0 10px 24px rgba(43,36,31,0.16); background: var(--vic-surface); border: 1px solid var(--vic-border-soft); }
